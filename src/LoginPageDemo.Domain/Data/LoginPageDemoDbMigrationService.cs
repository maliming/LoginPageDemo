...
{
    public class LoginPageDemoDbMigrationService : ITransientDependency
    {
        public ILogger<LoginPageDemoDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<ILoginPageDemoDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public LoginPageDemoDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<ILoginPageDemoDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<LoginPageDemoDbMigrationService>.Instance;
        }
